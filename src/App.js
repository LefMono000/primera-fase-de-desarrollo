    ...
    <div className="App">
      ...
      <main className="main-content">
        <section className="about-us">
          <h2>¿Quienes somos?</h2>
          <p>
            Aqui puedes inventarte datos sobre la comunidad residencial Los Robles, poner datos geográficos y hablar bien de la comunidad. Podemos inventarlo por ser algo ficticio, es solo para ir rellenando. De preferencia un párrafo o dos de información.
          </p>
